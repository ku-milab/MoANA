...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, strides=(2, 2, 2, 2), dilations=(1, 1, 1, 1)):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=strides[3], dilation=dilations[3], propose=True)
        self.inplanes = 1024
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1, propose=False):
        downsample = None
