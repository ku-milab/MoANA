...
from modules import moana_module
...
class MoANA(nn.Module):
    ...
    def _make_layer(self, block: Type[Union[Bottleneck]], planes: int, blocks: int,
        ...
        if propose:
            layers.append(moana_module.moana(self.inplanes))
...
#             checkpoint = torch.load("./checkpoint/CUB_CAM.pth")
#             checkpoint = torch.load("./checkpoint/CUB_MoANA.pth")
#         elif module_name == "moana":
#             checkpoint = torch.load("./checkpoint/ILSVRC_CAM.pth")
#             checkpoint = torch.load("./checkpoint/ILSVRC_MoANA.pth")
#         if parallel:
